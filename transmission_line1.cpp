...
// problems noticed till now  : 
								1 : if we send data from A to B , it is received at B and then received at C and D and E and F as well 
...
void next_step()
{		
		int x=1;		//del with the GUI . NEEDED if non-GUI
...
//-----------------------------------------------------------------------------------------------
			...
			{	vector<int> xframe;
				...
				cout<<"\nThe frame to be sent is : ";
				for(int i=0;i<xframe.size();i++)
					cout<<xframe[i];

				// new update abdul -- if the xsender is jammed , don't update the status  of that sender to 2 ;
				status[xsender]=2;
...
//-----------------------------------------------------------------------------------------------
			...
			if(status[0]==2)										//pushing send stack or  if send stack is empty , changing status to 0(listen)
			...
			if(status[2]==2)											//pushing send stack or making status to 0
				{
...
//----------------------------------------------------------------------------------------------------
// after adding ----------------------------------------------********************************************** ABDUL DIDN'T UNDERSTAND THIS PART :
//----------------------------------------------------------------------------------------------------
